...
public class Data {
    ...
    static class VehicleSim {
        Integer n_visited_stops, n_served_pax, total_idle_t, total_distance, initial_loc;
        List<Vehicle.Route_stop> route_stops;

        VehicleSim (Integer n_visited_stops, Integer n_served_pax, Integer total_idle_t, List<Vehicle.Route_stop> route_stops, Integer total_distance, Integer initial_loc){
